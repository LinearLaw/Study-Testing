...
(function ($) {
    ...
    function move() {
        ...
        if (myScroll.y < main.max - 50) {
            ...
            var html = "";
            for (var i = 0; i < 10; i++) {
                html += '<li><a href="javascript:void(0);"><div class="imgBox"><img src="../../images/a_7.png" alt=""></div><h3>BLICSS SKEE女士双肩包</h3><div class="originPrice">原价:￥1273.00元</div><p>特价:999.00元</p><button>立即购买</button></a></li></li>';
            }
